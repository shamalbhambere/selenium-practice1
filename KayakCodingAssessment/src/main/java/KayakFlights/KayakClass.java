...
public class KayakClass {
	...
	private static final String[] mOriginCities = { "BOM", "PNQ", "DEL"};
	private static final String[] mDestinationCities = { "EWR", "JFK", "MDW"};
	private static int mCounter = 0;
	private static final String FLIGHT_TAB = "//a[@href='/flights']";
	...
	public static void enterTravelCities(String origin, String destination) {
		mDriver.findElement(By.xpath("//div[@aria-label='Flight origin input']")).sendKeys(origin);
		mDriver.findElement(By.xpath("//div[@class='Flight destination input']")).sendKeys(destination);
	}
	...
	public static void searchTrips() {
		for (int i = 0; i < mOriginCities.length; i++) {
			...
			mDriver.findElement(By.xpath("//*[@id='WjjV']/div[14]/div/div[2]/div[2]/div/ul/li[1]")).click();
...
/*	public static void clearSearchCriteria() {
		...
		mDriver.findElement(By.xpath("//div[@class='lNCO-inner']")).clear();
		mDriver.findElement(By.xpath("//input[@class='k_my-input'])")).clear();
	}*/
	...
	public static void compareDestinations(String origin, String destination) {
		...
		// Comapare the values
		Assert.assertEquals("The Origin Cities do not match",
				origin.contains(sourceCity));
		Assert.assertEquals("The destination cities do not match",
